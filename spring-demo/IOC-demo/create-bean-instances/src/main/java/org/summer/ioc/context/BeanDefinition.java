...
public class BeanDefinition implements Comparable<BeanDefinition>{
    ...
    public Object getRequiredInstance() {
        if (this.instance == null) {
            throw new BeanBaseException(String.format("Instance of bean with name '%s' and type '%s' is not instantiated during current stage.",
    ...
    public void setInstance(Object instance) {
        ...
        if (!this.beanClass.isAssignableFrom(instance.getClass())) {
            throw new BeanBaseException(String.format("Instance '%s' of Bean '%s' is not the expected type: %s", instance, instance.getClass().getName(),
