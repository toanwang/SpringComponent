...
import org.summer.ioc.scan.init.AnnotationInitBean;
import org.summer.ioc.scan.init.SpecifyInitBean;
import org.summer.ioc.scan.init.SpecifyInitConfiguration;
...
public class AnnotationConfigApplicationContextTest {
    ...
    @Test
    public void testInitMethod() throws IOException, URISyntaxException {
        AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(ScanApplication.class, createPropertyResolver());
        // test @PostConstruct:
        AnnotationInitBean bean1 = ctx.getBean(AnnotationInitBean.class);
        SpecifyInitBean bean2 = ctx.getBean(SpecifyInitBean.class);
//        SpecifyInitConfiguration bean3 = ctx.getBean(SpecifyInitConfiguration.class);
//        System.out.println();
